...
/*
    Bu adımda, tek bir Mars fotoğrafını yüklemek ve görüntülemek için bir AsyncImage composable fonksiyonu ekleyeceksiniz.
    AsyncImage, bir görüntü isteğini asenkron olarak yürüten ve sonucu işleyen bir composable'dır.
 */
